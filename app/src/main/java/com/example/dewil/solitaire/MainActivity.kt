...
import com.example.dewil.solitaire.no_android.*
...
class MainActivity : AppCompatActivity(), GameView {
    ...
    val tableuPileViews: Array<TableuPileView?> = arrayOfNulls(7)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        verticalLayout {
            ...
            linearLayout {
                ...
                for (i in 0..3) {
                    foundationPileViews[i] = foundationPileView(i).lparams(
                            cardWidth,
                            cardHeight)
                }
            }
            linearLayout {
                for (i in 0..6) {
                    tableuPileViews[i] = tableuPileView(i).lparams(cardWidth, matchParent)
                }
